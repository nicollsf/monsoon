...
const int UNUSEDPINS[16] = {22, 24, 26, 28, 30, 32, 34, 36, 38, 40, 42, 44, 46, 48, 50, 52};
...
void setup() 
{
  ...
  btSerial.begin(115200);  Serial.begin(115200);  // for blueSMIRF
  ...
  //if( 0 ) {  unsigned long awt = 0;  EEPROM.put(eepromaddr0+2, awt);  }
  ...
  if( rst==LOW ) {
    ...
    byte nwresets = EEPROM.read(eepromaddr0+1) + 1;
