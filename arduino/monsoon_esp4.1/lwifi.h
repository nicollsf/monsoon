...
const int numssids = 4;
const String ssids[numssids] = {"Galaxy A04e", "abjaterHAHAHA", "abjaterHAHAHA_ext", "abjaterHAHAHA_ext2"};
const String ssidpasses[numssids] = {"1122334455", "1122334455", "1122334455", "1122334455"};
