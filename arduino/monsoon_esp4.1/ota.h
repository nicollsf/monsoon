...
//#define OTA_JSON_URL   "http://34.89.101.249/monsoon/monsoon_esp4.1.json" // JSON filter file (see below)
#define OTA_JSON_URL   "http://www.dip.ee.uct.ac.za/~nicolls/ota/monsoon/monsoon_esp4.1.json" // JSON filter file (see below)
#define OTA_VERSION    "1.0.5" // The current version of this program
