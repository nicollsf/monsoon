...
extern float calibf_table_pwm[CALIBF_MAX_TABLE_PTS];
...
void save_calibf_table(int n_pts, const float raw_pts[], const float corr_pts[], const float pwm_pts[] = nullptr);
